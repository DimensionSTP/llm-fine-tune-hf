...
export TRL_VLLM_COMM_HOST=$vllm_server_host
...
accelerate launch \
    --num_processes=$num_processes_per_machine \
    --main_process_port=$main_process_port \
    --gpu_ids=$gpu_ids \
    main.py --config-name=grpo.yaml mode=train \
    ...
    +training_arguments.vllm_server_base_url=http://${vllm_server_host}:${vllm_server_port} \
    +training_arguments.vllm_group_port=$vllm_group_port \
